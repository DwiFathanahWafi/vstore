<div class="container-fluid">
    <button class="btn obrien-button-2 primary-color" data-toggle="modal" data-target="#tambah">Tambah Produk </button>
    <table class="table table-bordered mt-3">
        ...
        foreach ($produk as $mn) : ?>
            <tr>
                ...
                <td><?= anchor('datap/edit/' . $mn->id, '<div class="btn obrien-button-2 primary-color">
                                    <i class="fa fa-edit"></i></div>') ?></td>
                <td><?= anchor('datap/hapus/' . $mn->id, '<div class="btn obrien-button-2 black-color">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('datap/tambah_aksi'); ?>" method="post" enctype="multipart/form-data">
